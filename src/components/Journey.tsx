...
export default function Journey() {
  ...
  const stages = [
    ...
    },
    {
      ...
      description: "Con margen real, creamos tu perfil de inversión y tu asesor con IA personalizado te guía paso a paso.",
      items: ["Plan de inversión", "Asesor con IA personalizado", "Seguimiento continuo"],
