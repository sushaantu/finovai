      ...
      <div className="max-w-7xl mx-auto">
        <div className="grid gap-12 md:grid-cols-2 lg:grid-cols-5">
          ...
          <div className="lg:col-span-2">
            ...
            <p className="text-[--color-text-muted] mt-5 max-w-sm leading-relaxed">
              Tu asesor financiero con IA. Ordena tu casa financiera y luego invierte con proceso.
            </p>
            <p className="text-sm text-[--color-text-dim] mt-6 font-serif italic">
          ...
          <div>
            ...
            <ul className="space-y-4">
              <li>
                <a href="/#conectar" className="text-[--color-text-muted] hover:text-[--color-text] transition-colors duration-300">
                  Cómo funciona
                </a>
              </li>
              <li>
        ...
        <div className="flex flex-col md:flex-row justify-between items-center mt-20 pt-8 border-t border-white/5">
          ...
          <div className="flex items-center gap-5 mt-6 md:mt-0">
            <a href="#" className="group p-2 rounded-lg hover:bg-white/5 transition-colors" aria-label="Twitter">
              <svg className="w-5 h-5 text-[--color-text-dim] group-hover:text-[--color-text] transition-colors" fill="currentColor" viewBox="0 0 24 24">
                <path d="M24 4.557c-.883.392-1.832.656-2.828.775 1.017-.609 1.798-1.574 2.165-2.724-.951.564-2.005.974-3.127 1.195-.897-.957-2.178-1.555-3.594-1.555-3.179 0-5.515 2.966-4.797 6.045-4.091-.205-7.719-2.165-10.148-5.144-1.29 2.213-.669 5.108 1.523 6.574-.806-.026-1.566-.247-2.229-.616-.054 2.281 1.581 4.415 3.949 4.89-.693.188-1.452.232-2.224.084.626 1.956 2.444 3.379 4.6 3.419-2.07 1.623-4.678 2.348-7.29 2.04 2.179 1.397 4.768 2.212 7.548 2.212 9.142 0 14.307-7.721 13.995-14.646.962-.695 1.797-1.562 2.457-2.549z" />
              </svg>
            </a>
            <a href="#" className="group p-2 rounded-lg hover:bg-white/5 transition-colors" aria-label="Instagram">
              <svg className="w-5 h-5 text-[--color-text-dim] group-hover:text-[--color-text] transition-colors" fill="currentColor" viewBox="0 0 24 24">
            ...
            <a href="#" className="group p-2 rounded-lg hover:bg-white/5 transition-colors" aria-label="LinkedIn">
              <svg className="w-5 h-5 text-[--color-text-dim] group-hover:text-[--color-text] transition-colors" fill="currentColor" viewBox="0 0 24 24">
