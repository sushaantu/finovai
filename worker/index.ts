...
import {
  ...
  type CategoryBudgetComparison,
  type CategoryBudgetStatus,
  type CategoryMonthRow,
  type DashboardDebtGate,
  type DashboardFinancialStage,
  type DashboardFinancialStageAssessment,
  type DashboardIncomeGuidance,
  type FinanceActionPlan,
  type FinanceDataCoverage,
  type FinanceInsight,
  type FinanceOpportunity,
  type FinanceOpportunityKind,
  type FinanceSummary,
